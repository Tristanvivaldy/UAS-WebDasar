let random = Math.floor(Math.random()*499)+1
        ...
        $(".field").css({"background-image":"url('Assets/Battle/Field"+fieldrandom+".jpg')","background-size":"cover","background-repeat":"no-repeat","background-position": "bottom"})
        if (fieldrandom == 1) {
            ...
            $(".player").css({"left":"15%","top":"30%"})
            $(".computer").css({"right":"15%","top":"-4%"})
            $(".HP1").css({"left":"-180px","top":"-40px"})
            $(".HP2").css({"right":"280px","top":"30px"})
            acak (400, 250);
        }
